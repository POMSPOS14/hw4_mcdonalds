...
class McdonaldsImplServiceTest {
    ...
    void saleOneProduct() {
        ...
        productRepository.create(new CheesecakeModel(1, "American_Cheese", 150, Category.DESSERTS, 2000));
        productRepository.create(new ColaModel(1, "Cola_Zero", 80, Category.DRINKS, 20, 400));
        productRepository.create(new ColaModel(1, "Cola", 80, Category.DRINKS, 200, 400));
    ...
    void getProductForCategory() {
        ...
        productRepository.create(new CheesecakeModel(1, "American_Cheese", 150, Category.DESSERTS, 2000));
        productRepository.create(new ColaModel(1, "Cola_Zero", 80, Category.DRINKS, 20, 400));
        productRepository.create(new FrenchFriesModel(1, "FrenchFries", 50, Category.POTATO, 200));
    ...
    void updateInProductRepository() {
        ...
        productRepository.create(new ColaModel(1, "Cola_Zero", 80, Category.DRINKS, 20, 400));
        productRepository.create(new FrenchFriesModel(1, "FrenchFries", 50, Category.POTATO, 200));
        productRepository.update(new ColaModel(2, "Cola_Zero", 100, Category.DRINKS, 20, 500));
        int price = productRepository.readById(2).get().getPrice();
...
//        productRepository.create(new CheesecakeModel(1, "American_Cheese", 150, Category.DESSERTS, 2000));
//        productRepository.create(new ColaModel(1, "Cola_Zero", 80, Category.DRINKS, 20, 400));
//        ordersRepository.create(productRepository,0);
//
////        assertThrows(Exception.class, () -> ordersRepository.update(1,productRepository,2));
//    }
